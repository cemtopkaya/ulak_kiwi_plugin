module UlakTest
  module PluginSetting
    ...
    def self.get_kiwi_settings
      ...
      jenkins_job_url = Setting[$PLUGIN_NAME_KIWI_TESTS]["jenkins_job_url"]
      jenkins_job_auth_token = Setting[$PLUGIN_NAME_KIWI_TESTS]["jenkins_job_auth_token"]
      ...
      @kiwi_settings = {
        ...
        jenkins_job_auth_token: jenkins_job_auth_token,
        kiwi_url: kiwi_url,
        url: rest_api_url,
